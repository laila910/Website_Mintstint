    ...
    <div class="section wb">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="message-box">                        
                        @if(session('lang')=='en')<h2>Designing and Creating Websites and E-stores @endif</h2>
                        @if(session('lang')=='ar') <h2 class="text-right">تصميم وانشاء المواقع والمتاجر الالكترونية @endif</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="left-box-pro wow fadeIn">
                        <img src="assets/uploads/1.jpg" alt="" id="imgcenter" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
                ...
                <div class="col-md-3">
                    <div class="left-box-pro wow fadeIn">
                        <img src="assets/uploads/2.jpg" alt=""  id="imgcenter" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="left-box-pro wow fadeIn">
                        <img src="assets/uploads/3.jpg" alt=""   id="imgcenter" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
                ...
                <div class="col-md-3">
                    <div class="left-box-pro wow fadeIn">
                        <img src="assets/uploads/4.jpg" alt=""  id="imgcenter" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="left-box-pro wow fadeIn">
                        <img src="assets/uploads/5.jpg" alt=""  id="imgcenter" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
                ...
                <div class="col-md-3">
                    <div class="left-box-pro wow fadeIn">
                        <img src="assets/uploads/6.jpg" alt=""   id="imgcenter" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="left-box-pro wow fadeIn">
                        <img src="assets/uploads/7.jpg" alt=""  id="imgcenter" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
                ...
                <div class="col-md-3">
                    <div class="left-box-pro wow fadeIn">
                        <img src="assets/uploads/8.jpg" alt=""  id="imgcenter" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
